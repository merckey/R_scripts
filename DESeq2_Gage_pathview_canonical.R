...
setwd("~/Desktop/RNAseq_Nicole_Ecad/Gage_pathview/Canonical_group/")
...
sel <- fc.kegg.2p$greater[,'q.val'] < 0.10 & !is.na(fc.kegg.p$less[,'q.val'])
path.ids <- rownames(fc.kegg.p$greater)[sel]
sel.l <- fc.kegg.2p$less[, "q.val"] < 0.10 & !is.na(fc.kegg.p$less[,"q.val"])
...
write.table(fc.kegg.2p$greater,file='2014-8-6-Canonical-greater.txt',sep='\t')
write.table(rbind(fc.kegg.2p$greater,fc.kegg.2p$lesser),file='2014-8-6-Canoical-KEGG.txt',sep='\t')